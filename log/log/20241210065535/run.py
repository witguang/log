...
# 数据加载
data = pd.read_csv("/home/linux1/PhySO/train-all-r11193.csv")
...
try:
    ...
    run_logger, run_visualiser, save_dir = save_files_with_timestamp(
        data_path="/home/linux1/PhySO/train-all-r11193.csv", log_dir="/home/linux1/PhySO/log")
    ...
    expression, logs = physo.SR(
        ...
        op_names=["add", "sub", "mul", "div", "exp", "log","n2", "sqrt", "n3", "n4", "inv","sin", "cos", "tan",  "expneg", "logabs","tanh"],
